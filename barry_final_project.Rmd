...
aes(x= emotion, y= episode,fill="coral 1")+ #assigning X and Y axes
...
ggplot()+ #ringing in ggplot
aes(x=season, y= emotion,fill="coral 1")+ #assigning axes
geom_col()+ #creates plot
theme_classic()+ #changing background
labs(x="Season",y ="Emotion", title= "Q2 Plot", width=5, height=7) #naming X and Y axes, adding a title and the height and width. 
```
...
geom_col()+ #creating the graph 
theme_classic()+ #changing the theme/background of the graph 
labs(x= "Emotions", y="Episodes", title = "Q3 Plot", width=5,height=6) #naming X and Y axes, adding a title and the height and width. 
...
friends_emotions%>% #ringing in friends emotions data
  ggplot()+ #ringing in ggplot
aes(x=emotion, fill="coral 1")+ #assigning the X axes
geom_bar()+ #creating the graph 
theme_classic()+ #changing the theme/background of the graph 
labs(x= "Emotions",  title = "Q4 Plot", width=6,height=6) #naming X and Y axes, adding a title and the height and width. 
